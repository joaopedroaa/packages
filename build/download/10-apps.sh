echo "============================== Apps / Apps / Arch! (2) ====================="
yay -S paru ntp --noconfirm
clear
...
echo "============================== Apps / Media / Video! (2) ====================="
yay -S vlc obs-studio --noconfirm
clear

echo "============================== Apps / Hardware / Boot! (3) ====================="
yay -S os-prober grub-customizer woeusb --noconfirm
clear

echo "============================== Apps / Hardware / Cpu! (3) ====================="
yay -S cpu-x-git s-tui stress --noconfirm
clear

echo "============================== Apps / Hardware / Gpu! (1) ====================="
yay -S gwe --noconfirm
clear

echo "============================== Apps / Hardware / Hd! (4) ====================="
